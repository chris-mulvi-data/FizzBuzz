...
VERSIONS: list[dict] = [
    {"label": "basic", "method": basic_fizzbuzz.basic_fizzbuzz},
    {"label": "one-liner", "method": oneline_fizzbuzz.oneline_fizzbuzz},
    {"label": "extensible", "method": extensible_fizzbuzz.extensible_fizzbuzz},
    {"label": "four lines", "method": four_lines_fizzbuzz.four_line_fizzbuzz},
    {"label": "UI FizzBuzz", "method": ui_fizzbuzz.ui_fizzbuzz},
    {"label": "Vs. FizzBuzz", "method": vs_fizzbuzz.vs_fizzbuzz},
]
